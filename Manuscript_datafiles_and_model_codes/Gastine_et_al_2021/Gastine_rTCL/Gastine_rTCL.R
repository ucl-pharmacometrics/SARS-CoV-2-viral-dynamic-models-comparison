...
mod.dir <- "/home/akosua/Documents/Model_evaluation/SARS_CoV-2_viral_dynamic_models_comparison/Gastine_et_al_2021/Gastine_rTCL/"
setwd(mod.dir)
library(ggplot2)
library(scales)
library(deSolve)
...
################################################################### end VPC + GGPLOT
#
run.rec[1, ] <- c("vl_dat_14days_post_symptom", "rTCL model", round(run1.lst$OBJF),round(run1.lst$AIC), round(run1.lst$BIC) )
#
