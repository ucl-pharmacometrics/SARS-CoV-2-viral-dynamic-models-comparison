...
mod.dir <- "/home/akosua/Documents/Model_evaluation/SARS_CoV-2_viral_dynamic_models_comparison/Gastine_et_al_2021/Gastine_TCL/"
setwd(mod.dir)
library(ggplot2)
library(scales)
library(deSolve)
...
dev.off()
#
run.rec[1, ] <- c("0.5", "vl_dat_14days_post_symptom", "TCL model", round(run0.5.lst$OBJF),round(run0.5.lst$AIC), round(run0.5.lst$BIC) )
#
#################
#
##### read data ######################################################################## 1 Day
...
dev.off()
#
run.rec[2, ] <- c("1", "vl_dat_14days_post_symptom", "TCL model", round(run1.lst$OBJF),round(run1.lst$AIC), round(run1.lst$BIC) )
#
#################
#
##### read data ######################################################################## 1.5 Days
...
dev.off()
#
run.rec[3, ] <- c("1.5", "vl_dat_14days_post_symptom", "TCL model", round(run1.5.lst$OBJF),round(run1.5.lst$AIC), round(run1.5.lst$BIC) )
#
#################
#
##### read data ######################################################################## 2 Days
...
dev.off()
#
run.rec[4, ] <- c("2", "vl_dat_14days_post_symptom", "TCL model", round(run2.lst$OBJF),round(run2.lst$AIC), round(run2.lst$BIC) )
#
#################
#
##### read data ######################################################################## 3 Days
...
dev.off()
#
run.rec[5, ] <- c("3", "vl_dat_14days_post_symptom", "TCL model", round(run3.lst$OBJF),round(run3.lst$AIC), round(run3.lst$BIC) )
#
#################
#
##### read data ######################################################################## 4 Days
...
dev.off()
#
run.rec[6, ] <- c("4", "vl_dat_14days_post_symptom", "TCL model", round(run4.lst$OBJF),round(run4.lst$AIC), round(run4.lst$BIC) )
#
#################
#
##### read data ######################################################################## 5 Days
...
dev.off()
#
run.rec[7, ] <- c("5", "vl_dat_14days_post_symptom", "TCL model", round(run5.lst$OBJF),round(run5.lst$AIC), round(run5.lst$BIC) )
#
#################
#
##### read data ######################################################################## 6 Days
...
dev.off()
#
run.rec[8, ] <- c("6", "vl_dat_14days_post_symptom", "TCL model", round(run6.lst$OBJF),round(run6.lst$AIC), round(run6.lst$BIC) )
#
#################
#
##### read data ######################################################################## 7 Days
...
dev.off()
#
run.rec[9, ] <- c("7", "vl_dat_14days_post_symptom", "TCL model", round(run7.lst$OBJF),round(run7.lst$AIC), round(run7.lst$BIC) )
#
#################
#
##### read data ######################################################################## 8 Days
...
dev.off()
#
run.rec[10, ] <- c("8", "vl_dat_14days_post_symptom", "TCL model", round(run8.lst$OBJF),round(run8.lst$AIC), round(run8.lst$BIC) )
#
#################
#
##### read data ######################################################################## 9 Days
...
dev.off()
#
run.rec[11, ] <- c("9", "vl_dat_14days_post_symptom", "TCL model", round(run9.lst$OBJF),round(run9.lst$AIC), round(run9.lst$BIC) )
#
#################
#
##### read data ######################################################################## 10 Days
...
dev.off()
#
run.rec[12, ] <- c("10", "vl_dat_14days_post_symptom", "TCL model", round(run10.lst$OBJF),round(run10.lst$AIC), round(run10.lst$BIC) )
#
###########################
#
##### read data ######################################################################## 11 Days
...
dev.off()
#
run.rec[13, ] <- c("11", "vl_dat_14days_post_symptom", "TCL model", round(run11.lst$OBJF),round(run11.lst$AIC), round(run11.lst$BIC) )
#
###########################
#
##### read data ######################################################################## 12 Days
...
dev.off()
#
run.rec[14, ] <- c("12", "vl_dat_14days_post_symptom", "TCL model", round(run12.lst$OBJF),round(run12.lst$AIC), round(run12.lst$BIC) )
#
###########################
#
##### read data ######################################################################## 13 Days
...
dev.off()
#
run.rec[15, ] <- c("13", "vl_dat_14days_post_symptom", "TCL model", round(run13.lst$OBJF),round(run13.lst$AIC), round(run13.lst$BIC) )
#
##########################
#
##### read data ######################################################################## 14 Days
...
dev.off()
#
run.rec[16, ] <- c("14", "vl_dat_14days_post_symptom", "TCL model", round(run14.lst$OBJF),round(run14.lst$AIC), round(run14.lst$BIC) )
#
...
c <- 0.64
#
R0 <- (rho*beta*A_T)/(delta*c) # 16786.68
#
...
#
## Fit the model 
run0.5.lstRo <- nlmixr(TCLRo, vl_dat, est = "saem",
                     control = saemControl(
                       seed = 99,
                       nu = c(2,2,2)),
                     table = tableControl(npde = TRUE, censMethod = c("cdf")))
...
c <- 58.5
#
R0 <- (rho*beta*A_T)/(delta*c) # c_fixed (10) = 1217.31, c/b_fixed (10/0.0005) = 8275.36, rho_fixed (10) = 20886.10
#
### Duration of virus production (L)
L <- 1/delta # c_fixed (10) = 8.13, c/b_fixed (10/0.0005) = 2.90, rho_fixed (10) = 1.73
#
#### end ###
